...
removal_manifest = ".repo/local_manifests/00_nad_removals.xml"
...
def fetch_dependencies(repo_path):
    ...
    dependencies_path = repo_path + '/nad.removal.dependencies'
    syncable_repos = []
...
def remove_removals(removal_manifest):
    tmp_manifest_disable = ".repo/local_manifests/local_nad.xml"
